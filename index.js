...
const sessdata = config.SESSION_ID.replace("TECH-MASTER~", '');
...
console.log("CONNECTING TECH-MASTER 🧬...");
...
console.log('TECH-MASTER CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ TECH-MASTER ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ SK HACKER ✅*

> *❁ᴊᴏɪɴ ᴏᴜʀ ᴡʜᴀᴛsᴀᴘᴘ ᴄʜᴀɴɴᴇʟ ғᴏʀ ᴜᴘᴅᴀᴛᴇs 

*https://whatsapp.com/channel/0029Vb5pqpiAO7RC8BlVO40H/268*

*SK-MDV1 ACTIVE NOW ENJOY♥️🪄*\n\n*PREFIX: ${prefix}*
...
if(senderNumber.includes("923192730918")){
if(isReact) return
m.react("🦋")
   }
...
app.get("/", (req, res) => {
res.send("HEY, TECH-MASTER STARTED ✅");
});
